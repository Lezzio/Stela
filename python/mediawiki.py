...
def getValue(person, value, n):
    ...
    print(wikipedia.search(person))
    person = wikipedia.search(person)[n]
    ...
    if response == '':
        ...
        for resulte in resultats["results"]["bindings"]:
            ...
            print('Ifind', response)

    return response

print(getValue('Nikola Tesla né', 'birthDate',0))
...
def gettranslation(text, target):
    ...
    print('Detect language:', langdetected)
